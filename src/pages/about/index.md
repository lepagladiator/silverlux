...
.flex-col,.flex-col-around {
    flex-direction: column
}

.flex-around,.flex-col-around {
...
.card {
    ...
    color: #333;
    border-radius: 10px;
    box-shadow: 0 3px 8px hsla(0,0%,40.8%,.2);
    padding: 20px;
    margin: 10px
}
...
.scroll-to-top:before {
    content: url(data:image/svg+xml;base64,);
    padding: 7px;
    justify-content: center;
    align-items: center;
    opacity: .35;
...
.blogContainer,.blogPostContentsContainer {
    width: 80vw;
    margin: 4em auto;
    position: relative
}
...
.blogPostContentsContainer p {
    text-align: justify;
    width: 100%!important
}

.blogPostContentsContainer p img {
...
.blogPostContentsContainer h1:after,.blogPostContentsContainer h2:after,.blogPostContentsContainer h3:after,.blogPostContentsContainer h4:after {
    position: absolute;
    margin-top: -.45em;
    margin-left: -10px;
    display: block;
...
.blogPostContentsContainer h2:after {
    background: #a5f1b1
}

.blogPostContentsContainer h3:after {
    background: #9cf5f0
}
